...
function play_button_1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to play_button_1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes during object deletion, before destroying properties.
function pause_button_1_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to pause_button_1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
